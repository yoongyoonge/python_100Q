...
# Google Trend 접속
trend_obj = TrendReq(timeout=(10,25))
trend_obj.build_payload(kw_list=[keyword], timeframe=period)


#print(type(trend_obj.interest_by_region()))
# 지역별 검색 Trend 비교
...
# 그래프 파일 저장
cwd = os.getcwd()
output_filepath = os.path.join(cwd, "code\\3. API\\output", "google_trend_by_region_%s.png" % keyword)
